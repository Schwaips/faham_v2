def authenticate_admin!
  puts "AUTHENTICATE ADMIN"
  redirect_to root_path, flash[:alert] = "You are not authorized to access this page." unless current_user.admin?
end
...
ActiveAdmin.setup do |config|
  ...
  #
  config.site_title = "Faham - Estelle Laboureur"
